...
const CHALS = {
  ...
  16: {
    ...
    effDesc(x) {
      return formatPow(x) + x.softcapHTML(3);
    },
  },
  17: {
    unl() {
  ...
  18: {
    ...
    effDesc(x) {
      return (
        (x[1].lt(1) ? `${formatReduction(x[1])} to those scalings, ` : "") +
        formatPercent(x[0].sub(1)) +
        " stronger"
      );
    },
  },

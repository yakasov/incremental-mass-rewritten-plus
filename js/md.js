const MASS_DILATION = {
    ...
    penalty() {
        ...
        if (
            QCs.active() &&
            (player.md.break.active ? !player.qu.rip.active : true)
        )
            x **= tmp.qu.qc_eff[6];
        return x;
    },
    ...
    upgs: {
        ...
        ids: [
            ...
            },
            {
                ...
                effDesc(x) {
                    return (
                        (x.gte(10)
                            ? format(x) + "x"
                            : format(x.sub(1).mul(100)) + "%") + " stronger"
                    );
                },
            },
            {
            ...
            },
            {
                ...
                bulk() {
                    return player.md.mass.gte(E(1.619e20).mul(25))
                        ? E(1)
                        : E(0);
                },
                effect(x) {
    ...
    break: {
        toggle() {
            ...
            if (bd.active)
                createConfirm(
                    "Are you sure you want to fix Dilation?",
                    "bd",
                    () => {
                        bd.active = false;
                        ...
                        for (
                            let x = 0;
                            x < MASS_DILATION.break.upgs.ids.length;
                            x++
                        )
                            bd.upgs[x] = E(0);
        ...
        massGain() {
            ...
            if (player.md.break.upgs[7].gte(1))
                x = x.mul(tmp.bd.upgs[7].eff || 1);
            if (player.md.break.upgs[8].gte(1))
                x = x.mul(tmp.bd.upgs[8].eff || 1);
        ...
        upgs: {
            ...
            ids: [
                ...
                },
                {
                    ...
                    bulk() {
                        return player.md.break.mass.gte(uni(1e35))
                            ? E(1)
                            : E(0);
                    },
                    effect(y) {
                ...
                },
                {
                    ...
                    bulk() {
                        return player.md.break.mass.gte(uni(1e48))
                            ? E(1)
                            : E(0);
                    },
                    effect(y) {
                ...
                },
                {
                    ...
                    bulk() {
                        return player.md.break.mass.gte(uni(1e100))
                            ? E(1)
                            : E(0);
                    },
                    effect(y) {
                ...
                },
                {
                    ...
                    bulk() {
                        return player.md.break.mass.gte(uni(1e120))
                            ? E(1)
                            : E(0);
                    },
                },
                {
                    ...
                    bulk() {
                        return player.md.break.mass.gte(uni(1e240))
                            ? E(1)
                            : E(0);
                    },
                },

const INF = {
    doReset() {
        ...
        for (let x = 0; x < PRESTIGES.names.length; x++)
        ...
        if (CHALS.inChal(19) || !hasElement(47, 1))
        ...
        */
        ...
        if (tmp.stab[8] == 0) updateCoreHTML();
            ...
            for (let r in INF.upgs) {
                ...
                let unl =
                    (r == 0 ||
                        player.inf.theorem.gte(INF.upg_row_req[r - 1])) &&
                ...
                for (let c in ru) {
                    ...
                    if (el) {
                        ...
                        el.setClasses({
                            inf_upg: true,
                            locked:
                                !b && (player.inf.points.lt(u.cost) || !req),
                            bought: b,
                        });

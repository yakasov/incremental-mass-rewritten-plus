  ...
  mass_3: {
    ...
    effect(x) {
      ...
      if (player.mainUpg.rp.includes(12))
        step = step.add(tmp.upgs.main ? tmp.upgs.main[1][12].effect : E(0));
  ...
  bhc: {
    ...
    effect(x) {
      ...
      if (player.mainUpg.bh.includes(2))
        pow = pow.mul(tmp.upgs.main ? tmp.upgs.main[2][2].effect : E(1));
      pow = pow.add(tmp.atom.particles[2].powerEffect.eff2);
      if (player.mainUpg.atom.includes(11))
        pow = pow.mul(tmp.upgs.main ? tmp.upgs.main[3][11].effect : E(1));
  ...
  cosmic_ray: {
    ...
    effect(x) {
      ...
      if (player.mainUpg.atom.includes(4))
        pow = pow.add(tmp.upgs.main ? tmp.upgs.main[3][4].effect : E(0));
      if (player.mainUpg.atom.includes(11))
        pow = pow.mul(tmp.upgs.main ? tmp.upgs.main[3][11].effect : E(1));
    ...
    get_power: (x) => formatMult(x.power),
    get_effect: (x) =>
      formatMult(x.effect) + (hasGlyphUpg(12) ? ", ^" + format(x.exp) : ""),
  },
  star_booster: {
    name: "Star Booster",
    icon: "star_booster",
    ...
    get_power: (x) =>
      formatMult(x.power) + x.power.softcapHTML(1e13, hasUpgrade("atom", 22)),
    get_effect: (x) =>
      formatMult(x.effect) +
      " to star generators" +

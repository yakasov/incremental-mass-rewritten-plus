...
const BUILDINGS_DATA = {
  ...
  tickspeed: {
    ...
    get autoUnlocked() {
      return hasUpgrade("bh", 5);
    },
    get noSpend() {
      return hasUpgrade("atom", 2);
    },
  ...
  accelerator: {
    ...
    get isUnlocked() {
      return tmp.rp.unl && hasElement(199);
    },
    get autoUnlocked() {
      return true;
    },
  ...
  bhc: {
    ...
    effect(x) {
      ...
      let os = tmp.c16.in ? E("ee150") : E("ee10000"),
        op = E(0.5),
        o = eff;
  ...
  fvm: {
    ...
    get isUnlocked() {
      return tmp.bh.unl && hasCharger(1);
    },
    get autoUnlocked() {
      return true;
    },
    ...
    get allowPurchase() {
      return tmp.c16.in || hasElement(277);
    },

const ELEMENTS = {
  ...
  upgs: [
    ...
    },
    {
      ...
      effect() {
        if (!tmp.star_unl) return E(1);
        return hasElement(236) || OURO.evo >= 2
    ...
    },
    {
      ...
      effDesc(x) {
        return OURO.evo >= 2 ? undefined : formatPow(x) + " later";
      },
    },
    {
    ...
    },
    {
      ...
      get cost() {
        return OURO.evo >= 2 ? E("e7e12") : E("e1.4e13");
      },
    },
    {
    ...
    },
    {
      ...
      effect() {
        if (!tmp.atom.unl) return E(1);
        return E(OURO.evo >= 2 ? 0.998 : 0.9).pow(
    ...
    },
    {
      ...
      effDesc(x) {
        return OURO.evo < 3 ? undefined : formatMult(x);
      },
    },
    {
      dark: true,
    ...
    },
    {
      ...
      effect() {
        ...
        let x = hasPrestige(0, 218)
          ? Decimal.pow(10, pb.add(1).log10().root(2))
    ...
    },
    {
      ...
      get cost() {
        return E(OURO.evo >= 1 ? "e8e68" : "e2.2e69");
      },
    },
    {
      br: true,
    ...
    },
    {
      ...
      get cost() {
        return E(OURO.evo >= 1 ? "e1e69" : "e2e69");
      },
    },
    {
    ...
    },
    {
      ...
      get cost() {
        return E(OURO.evo >= 2 ? "e1e66" : OURO.evo >= 1 ? "e6e68" : "e4.2e69");
      }, // nice
    },
    {
      br: true,
      ...
      get cost() {
        return E(OURO.evo >= 2 ? "e1e67" : "e6.3e69");
      },
    },
    {
      br: true,
    ...
    },
    {
      ...
      get cost() {
        return E(OURO.evo >= 1 ? "e1e71" : "e1.08e72");
      },
    },
    {
      dark: true,
    ...
    },
    {
      ...
      get cost() {
        return E(OURO.evo >= 1 ? "e1e123" : "e3.1e123");
      },
    },
    {
    ...
    },
    {
      ...
      get cost() {
        return E(OURO.evo >= 1 ? "e1e134" : "e7e134");
      },
    },
    {
    ...
    },
    {
      ...
      cost: E("ee294"),
      effect() {
        let x = GPEffect(1, E(1)).root(OURO.evo >= 2 ? 1 : 2);
        return x;
      },
      effDesc(x) {
        return formatReduction(x) + " weaker";
    ...
    },
    {
      ...
      get cost() {
        return OURO.evo >= 2 ? E("e8e10") : E("e1.67e11");
      },
      effect() {
    ...
    },
    {
      ...
      get cost() {
        return E(OURO.evo >= 1 ? "e1e12" : "e1.13e12");
      },
    },
    {
      inf: true,
      ...
      get cost() {
        return E(OURO.evo >= 3 ? 1e100 : OURO.evo >= 1 ? "e105" : "e110");
      },
    },
    {
    ...
    },
    {
      ...
      effDesc(x) {
        return formatPow(x) + x.softcapHTML(1e6);
      },
    },
    {
      proto: true,
  ...
  for (let k = 1; k <= MAX_ELEM_TIERS; k++) {
    ...
    for (let i = 0; i < ELEMENTS.map[k - 1].length; i++) {
      ...
      if (m == "v") table += `</div><div class="table_center">`;
        ...
        table += `<div ${ELEMENTS.la[m] !== undefined && k == 1 ? `id='element_la_${m}'` : ""} style="width: 50px; height: 50px">${ELEMENTS.la[m] !== undefined ? "<br>" + ELEMENTS.la[m] : ""}</div>`;
      else if (m == "x") {
        num++;
        table +=
...
function updateElementsHTML() {
  ...
  tmp.el.elemLayer.setDisplay(tmp.eaUnl || OURO.evo > 0);

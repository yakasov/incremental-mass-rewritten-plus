const MUONIC_ELEM = {
  upgs: [
    ...
    },
    {
      ...
      get cost() {
        return OURO.evo >= 2 ? E(1e29) : E(1e32);
      },
    },
    {
    ...
    },
    {
      ...
      get cost() {
        return OURO.evo >= 2 ? E(1e90) : E(1e100);
      },
      eff() {
    ...
    },
    {
      ...
      get cost() {
        return OURO.evo >= 2 ? E(1e95) : E(1e111);
      },
      eff() {
    ...
    },
    {
      ...
      get cost() {
        return OURO.evo >= 2 ? E(1e160) : E(1e170);
      },
      eff() {
    ...
    },
    {
      ...
      get cost() {
        return OURO.evo >= 2 ? E("e4000") : E("e7300");
      },
    },
    {
      cs: true,
    ...
    },
    {
      ...
      get cost() {
        return OURO.evo >= 2 ? E("e4500") : E("e8100");
      },
      eff() {
        if (!tmp.inf_unl) return E(1);
    ...
    },
    {
      ...
      get cost() {
        return OURO.evo >= 2 ? E("e4700") : E("e8600");
      },
      eff() {
    ...
    },
    {
      ...
      get cost() {
        return OURO.evo >= 2 ? E("e4900") : E("e9200");
      },
    },
    {
      desc: `Boost Supernova Generation based on beyond-ranks' maximum tier.`,
      get cost() {
        return OURO.evo >= 2 ? E("e5250") : E("e12100");
      },
    ...
    },
    {
      ...
      get cost() {
        return OURO.evo >= 2 ? E("e5460") : E("e14900");
      },
    },
    {
    ...
    },
    {
      ...
      get cost() {
        return OURO.evo >= 2 ? E("e780") : E("e840");
      },
    },
    {
    ...
    },
    {
      ...
      eff() {
        let x =
          OURO.evo >= 1 ? player.evo.cp.level.div(1e7).add(1).sqrt() : E(1);
        return x;
      },
      effDesc: (x) => formatMult(x),
    },
...
const EXOTIC_ATOM = {
  ...
  gain() {
    ...
    if (OURO.evo >= 2 && hasElement(48, 1))
      x = x.pow(player.inf.theorem.add(1).log10().add(1.5));
    ...
    if (OURO.evo >= 2 && hasElement(48, 1))
      y = y.pow(player.inf.theorem.add(1).log10().add(1.5));
  ...
  milestones: [
    [
      ...
      [
        ...
        (x) =>
          `Ultra & Meta-Prestige Levels start <b>${formatMult(x)}</b> later`,
      ],
      [
        (a) => {
      ...
      [
        ...
        (x) =>
          `Weaken softcaps of atomic power's effect by <b>${formatReduction(x)}</b>`,
      ],
      [
        (a) => {
        ...
        (x) =>
          `Increase the base of Prestige Level 382 for Collapsed Star's effect, the base of Binilunium-201 for BH's effect by <b>+${format(x)}</b>`,
      ],
    ],
    [
      [
...
function updateExoticAtomsTemp() {
  ...
  tea.amount =
    OURO.evo >= 3 ? player.evo.proto.exotic_atoms : EXOTIC_ATOM.getAmount();
...
function exoticAEff(i, j, def = 1) {
  return tmp.exotic_atom.eff[i][j] || def;
}

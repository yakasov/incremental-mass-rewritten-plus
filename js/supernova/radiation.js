const RADIATION = {
    ...
    ds_gain(i) {
        ...
        if (i < RAD_LEN - 1) {
            if (
                hasTree("rad1") &&
                player.supernova.radiation.hz.gte(RADIATION.unls[i + 1])
            )
                x = x.mul(tmp.supernova.tree_eff.rad1 || 1);
    ...
    ds_eff(i) {
        let x = player.supernova.radiation.ds[i]
            .add(1)
            .root(3)
    ...
    getBoostData(i) {
        ...
        let bulk = d.lt(f3)
            ? E(0)
            : d.div(f3).max(1).log(f1).max(0).root(f2).mul(fp).add(1).floor();
    ...
    getLevelEffect(i) {
        ...
        if (
            FERMIONS.onActive("15") ||
            (Math.floor(i / 3) > 0 &&
                player.supernova.radiation.hz.lt(
                    RADIATION.unls[Math.floor(i / 3)],
                ))
        )
            b = E(0);
    ...
    getbonusLevel(i) {
        ...
        x = hasUpgrade("bh", 24)
            ? x
                  .add(1)
                  .mul(tmp.chal ? tmp.chal.eff[12] : 0)
                  .sub(1)
            : x.add(tmp.chal ? tmp.chal.eff[12] : 0);
    ...
    buyBoost(i) {
        let [cost, bulk, j] = [
            tmp.radiation.bs.cost[i],
            tmp.radiation.bs.bulk[i],
            Math.floor(i / 2),
        ];
        if (
            player.supernova.radiation.ds[j].gte(cost) &&
            bulk.gt(player.supernova.radiation.bs[i])
        ) {
            player.supernova.radiation.bs[i] =
                player.supernova.radiation.bs[i].max(bulk);
            if (!hasTree("qol9")) {
                let [f1, f2, f3, fp] = [
                    2 + i / 2,
                    1.3 + i * 0.05,
                ...
                player.supernova.radiation.ds[j] =
                    player.supernova.radiation.ds[j]
                        .sub(E(f1).pow(bulk.sub(1).div(fp).pow(f2)).mul(f3))
                        .max(0);
            }
        }
    },
    autoBuyBoosts() {
        if (hasTree("qol9"))
            for (let x = 0; x < 2 * RAD_LEN; x++) this.buyBoost(x);
    },
    getBoostsFP() {
        let x = E(1);
    ...
    boosts: [
        {
            title: `Radio Boost`,
            eff(b) {
                let x = player.supernova.radiation.hz
                    .add(1)
                    .log10()
                    .add(1)
                    .pow(b)
            ...
            desc(x) {
                return `Radio wave is boosted by ${format(
                    x,
        ...
        },
        {
            ...
            desc(x) {
                return `Non-bonus tickspeeds are ${format(x)}x stronger`;
            },
        },
        {
            ...
            desc(x) {
                return `Mass softcap^3 starts ^${format(x)} later`;
            },
        },
        {
            title: `Microwave Boost`,
            eff(b) {
                let x = player.supernova.radiation.ds[0]
                    .add(1)
                    .log10()
                    .add(1)
                    .pow(b)
            ...
            desc(x) {
                return `Microwave is boosted by ${format(x)}x (based on Radio)`;
            },
        },
        {
            ...
            eff(b) {
                ...
                if (!tmp.dark.shadowEff.bhp) x = x.min(0.15);
                return x;
            },
            desc(x) {
        ...
        },
        {
            ...
            desc(x) {
                return `Non-bonus BH condenser is ${format(x)}x stronger`;
            },
        },
        {
            title: `Infrared Boost`,
            eff(b) {
                let x = player.supernova.radiation.ds[1]
                    .add(1)
                    .log10()
                    .add(1)
                    .pow(b)
            ...
            desc(x) {
                return `Infrared is boosted by ${format(
                    x,
                )}x (based on Microwave)`;
            },
        },
        {
            ...
            desc(x) {
                return `1st Photon & Gluon upgrades are ${format(x)}x stronger`;
            },
        },
        {
            title: `Meta-Boost I`,
            ...
            desc(x) {
                return `Add ${format(x)} levels to all above boosts`;
            },
        },
        {
            title: `Visible Boost`,
            eff(b) {
                let x = player.supernova.radiation.ds[2]
                    .add(1)
                    .log10()
                    .add(1)
                    .pow(b)
            ...
            desc(x) {
                return `Visible is boosted by ${format(
                    x,
                )}x (based on Infrared)`;
            },
        },
        {
            ...
            desc(x) {
                return `Cosmic Ray power is boosted by ${format(x)}x`;
            },
        },
        {
            ...
            desc(x) {
                return `Neutron Star is boosted by ${format(
                    x,
                )}x (based on Frequency)`;
            },
        },
        {
            ...
            eff(b) {
                let x = player.supernova.radiation.ds[3]
                    .add(1)
                    .log10()
                    .add(1)
                    .pow(b)
            ...
            desc(x) {
                return `Ultraviolet is boosted by ${format(
                    x,
                )}x (based on Visible)`;
            },
        },
        {
            ...
            desc(x) {
                return `Tickspeed power's softcap starts ${format(x)}x later`;
            },
        },
        {
            ...
            eff(b) {
                let x = E(1.025).pow(
                    b.softcap(13000, 0.2, 0).softcap(400, 0.5, 0),
                );
                return x;
            },
            desc(x) {
                return `Meta-Rank starts ${format(x)}x later`;
            },
        },
        {
            title: `X-ray Boost`,
            eff(b) {
                let x = player.supernova.radiation.ds[4]
                    .add(1)
                    .log10()
                    .add(1)
                    .pow(b)
            ...
            desc(x) {
                return `X-ray is boosted by ${format(
                    x,
                )}x (based on Ultraviolet)`;
            },
        },
        {
            ...
            desc(x) {
                return `U-Leptons are ${format(x)}x stronger`;
            },
        },
        {
            title: `Meta-Boost II`,
        ...
        },
        {
            ...
            eff(b) {
                let x = player.supernova.radiation.ds[5]
                    .add(1)
                    .log10()
                    .add(1)
                    .pow(b)
            ...
            desc(x) {
                return `Gamma-ray is boosted by ${format(x)}x (based on X-ray)`;
            },
        },
        {
            title: `U-Quark Boost`,
            ...
            desc(x) {
                return `U-Quarks are ${format(x)}x stronger`;
            },
        },
        {
            ...
            desc(x) {
                return `BH formula softcap starts ^${format(x)} later`;
            },
        },
...
function updateRadiationTemp() {
    ...
    for (let x = 0; x < RAD_LEN; x++) {
        ...
        tmp.radiation.bs.sum[x] = player.supernova.radiation.bs[2 * x].add(
            player.supernova.radiation.bs[2 * x + 1],
        );

        for (let y = 0; y < 3; y++) {
            tmp.radiation.bs.lvl[3 * x + y] = tmp.radiation.bs.sum[x]
                .add(2 - y)
                .div(3)
                .floor(); //.softcap(10,0.75,0)
            tmp.radiation.bs.bonus_lvl[3 * x + y] = RADIATION.getbonusLevel(
                3 * x + y,
            );
        }
        for (let y = 0; y < 2; y++)
            [
                tmp.radiation.bs.cost[2 * x + y],
                tmp.radiation.bs.bulk[2 * x + y],
            ] = RADIATION.getBoostData(2 * x + y);
    }
        ...
        <div id="${id}_div" class="table_center radiation">
            <div class="sub_rad" style="width: 450px">
                Your distance of ${name}'s wave is <span id="${id}_distance">0</span> meters.<br>Which multiples ${
                    x == 0
                        ? "Frequency"
                        : "distance of " + RADIATION.names[x - 1]
...
function updateRadiationHTML() {
    tmp.el.frequency.setTxt(
        format(player.supernova.radiation.hz, 1) +
            " " +
            formatGain(
                player.supernova.radiation.hz,
                tmp.radiation.hz_gain.mul(tmp.preQUGlobalSpeed),
            ),
    );
    ...
    for (let x = 1; x <= RAD_LEN; x++) {
        ...
        if (
            player.supernova.radiation.hz.lt(RADIATION.unls[x] || 1 / 0) ||
            comp
        )
            break;
        rad_id++;
    ...
    for (let x = 0; x < RAD_LEN; x++) {
        let unl =
            x == 0 || player.supernova.radiation.hz.gte(RADIATION.unls[x]);
        let id = `rad_${x}`;

        tmp.el[id + "_div"].setDisplay(unl);
        if (unl) {
            tmp.el[id + "_distance"].setTxt(
                format(player.supernova.radiation.ds[x], 1) +
                    " " +
                    formatGain(
                        player.supernova.radiation.ds[x],
                        tmp.radiation.ds_gain[x].mul(tmp.preQUGlobalSpeed),
                    ),
            );
            ...
            for (let y = 0; y < 2; y++) {
                ...
                tmp.el[id2 + "_cost"].setTxt(
                    format(tmp.radiation.bs.cost[b], 1),
                );
                tmp.el[id2 + "_btn"].setClasses({
                    btn: true,
                    rad: true,
                    locked: player.supernova.radiation.ds[x].lt(
                        tmp.radiation.bs.cost[b],
                    ),
                });
            }
            for (let y = 0; y < 3; y++) {
                ...
                tmp.el[id2].setTxt(
                    format(tmp.radiation.bs.lvl[lvl], 0) +
                        (tmp.radiation.bs.bonus_lvl[lvl].gt(0)
                            ? " + " + format(tmp.radiation.bs.bonus_lvl[lvl])
                            : "") +
                        (A23
                            ? ", ×" + RADIATION.getA23Bonus(lvl).format()
                            : ""),
                );
                tmp.el[id2 + "_desc"].setTxt(
                    RADIATION.boosts[lvl].desc(tmp.radiation.bs.eff[lvl]),
                );
            }
        }
    }

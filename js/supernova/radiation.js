const RADIATION = {
  ...
  getLevelEffect(i) {
    ...
    if (
      ...
      (Math.floor(i / 3) > 0 &&
        player.supernova.radiation.hz.lt(RADIATION.unls[Math.floor(i / 3)]))
    )
      b = E(0);
  ...
  buyBoost(i) {
    ...
    if (
      ...
      if (!hasTree("qol9")) {
        ...
        player.supernova.radiation.ds[j] = player.supernova.radiation.ds[j]
  ...
  boosts: [
    {
      ...
      desc(x) {
        return `Radio wave is boosted by ${format(x)}x (based on Frequency)`;
      },
    },
    {
    ...
    },
    {
      ...
      desc(x) {
        return `Infrared is boosted by ${format(x)}x (based on Microwave)`;
      },
    },
    {
    ...
    },
    {
      ...
      desc(x) {
        return `Visible is boosted by ${format(x)}x (based on Infrared)`;
      },
    },
    {
    ...
    },
    {
      ...
      desc(x) {
        return `Neutron Star is boosted by ${format(x)}x (based on Frequency)`;
      },
    },
    {
      ...
      desc(x) {
        return `Ultraviolet is boosted by ${format(x)}x (based on Visible)`;
      },
    },
    {
    ...
    },
    {
      ...
      desc(x) {
        return `X-ray is boosted by ${format(x)}x (based on Ultraviolet)`;
      },
    },
    {
...
function updateRadiationTemp() {
  ...
  for (let x = 0; x < RAD_LEN; x++) {
    ...
    for (let y = 0; y < 2; y++)
      [tmp.radiation.bs.cost[2 * x + y], tmp.radiation.bs.bulk[2 * x + y]] =
...
function updateRadiationHTML() {
  ...
  for (let x = 1; x <= RAD_LEN; x++) {
    ...
    if (player.supernova.radiation.hz.lt(RADIATION.unls[x] || 1 / 0) || comp)
      break;
    rad_id++;
  }
    ...
    if (unl) {
      ...
      for (let y = 0; y < 2; y++) {
        ...
        tmp.el[id2 + "_btn"].setClasses({
          btn: true,
          rad: true,
          locked: player.supernova.radiation.ds[x].lt(tmp.radiation.bs.cost[b]),
        });
      }
      for (let y = 0; y < 3; y++) {
        let lvl = 3 * x + y;

const TREE_TAB = [
  ...
  { title: "Challenge" },
  {
    ...
    unl() {
      return player.supernova.post_10;
    },
  },
  {
    title: "Quantum",
  ...
  },
  {
    title: "Corruption",
    unl() {
      return player.dark.c16.first || hasInfUpgrade(8);
    },
  },
];
...
const TREE_UPGS = {
  buy(x, auto = false) {
    ...
    if (!auto && tmp.sn.tree_choosed == x && this.ids[x].reqDesc && !hasTree(x))
      player.supernova.pin_req = x;
  },
  buyAll() {
    let cont = true;
    while (cont) {
  ...
  ids: {
    ...
    sn4: {
      ...
      req() {
        return player.supernova.times.gte(13);
      },
      ...
      effDesc(x) {
        return (
          "+" +
          format(x) +
          (x.gte(1.5) ? " <span class='soft'>(softcapped)</span>" : "")
        );
      },
    },
    sn5: {
    ...
    m1: {
      ...
      effect() {
        let x = E(1e100)
          .pow(
            player.supernova.stars.add(1).log10().pow(5).softcap(1e3, 0.25, 0),
          )
          .min("ee100");
        let y = E(1);
        if (hasElement(164) || hasElement(219))
          y = hasElement(219)
            ? Decimal.pow(
                1.25,
      ...
      effDesc(x) {
        return (
          format(x[0]) +
          "x" +
          (x[0].max(1).log(1e100).gte(1e3)
            ? " <span class='soft'>(softcapped)</span>"
            : "") +
          (hasElement(164) || hasElement(219) ? ", " + formatPow(x[1]) : "")
        );
      },
    },
    m2: {
    ...
    m3: {
      branch: ["m2"],
      unl() {
        return player.supernova.fermions.unl && hasTree("fn1");
      },
    ...
    t1: {
      ...
      req() {
        return (
          ...
          player.mass.gte(E("1.5e1.650056e6").pow(hasTree("bh2") ? 1.46 : 1))
        );
      },
      reqDesc() {
        return `Reach ${formatMass(E("1.5e1.650056e6").pow(hasTree("bh2") ? 1.46 : 1))} without buying Tickspeed in a Supernova run. You can still obtain Tickspeed from Cosmic Rays.`;
      },
    ...
    rp1: {
      ...
      effect() {
        if (OURO.evo >= 1)
          return hasElement(165)
            ? player.supernova.stars.add(1).log10().add(1).pow(2)
            : player.supernova.stars
                .add(1)
                .log10()
                .add(1)
    ...
    bh1: {
      ...
      effDesc(x) {
        return hasElement(166) || OURO.evo >= 2
          ? formatPow(x)
          : format(x) +
              "x" +
              (x.max(1).log(1e35).gte(1e3)
                ? " <span class='soft'>(softcapped)</span>"
                : "");
      },
    },
    bh2: {
      ...
      req() {
        return (
          player.supernova.chal.noBHC && player.bh.mass.gte("1.5e1.7556e4")
        );
      },
      reqDesc() {
        return `Reach ${format("e1.75e4")} uni of black hole without buying any BH Condenser in a Supernova run.`;
      },
    ...
    s2: {
      branch: ["s1"],
      req() {
        return player.supernova.times.gte(3);
      },
    ...
    s3: {
      branch: ["s2"],
      req() {
        return player.supernova.times.gte(4);
      },
    ...
    qol1: {
      req() {
        return player.supernova.times.gte(2);
      },
    ...
    qol4: {
      ...
      req() {
        return player.supernova.times.gte(12);
      },
    ...
    qol5: {
      branch: ["qol4"],
      req() {
        return player.supernova.times.gte(16);
      },
    ...
    qol6: {
      branch: ["qol5"],
      req() {
        return player.supernova.times.gte(17);
      },
    ...
    qol7: {
      branch: ["qol6"],
      unl() {
        return player.supernova.fermions.unl && hasTree("fn2");
      },
      req() {
        return OURO.evo >= 2 || player.supernova.times.gte(40);
      },
      reqDesc() {
        return OURO.evo >= 2
    ...
    qol8: {
      branch: ["unl1"],
      req() {
        return player.supernova.times.gte(60);
      },
    ...
    qol9: {
      branch: ["unl1"],
      req() {
        return player.supernova.times.gte(78);
      },
    ...
    chal2: {
      ...
      reqDesc() {
        return `Reach ${format("e2.05e6")} uni without challenge 1-4 completions in a Supernova run.`;
      },
    ...
    chal3: {
      ...
      reqDesc() {
        return OURO.evo >= 2
          ? `YOU CAN AFFORD BECAUSE OF EVOLUTION!`
          : `Reach ${format("e1.75e4")} uni of black hole without challenge 5-8 completions in a Supernova run.`;
      },
    ...
    chal7: {
      ...
      get cost() {
        return OURO.evo >= 2 ? E(1e150) : E(1e200);
      },
    },
    chal7a: {
      unl() {
    ...
    gr1: {
      ...
      req() {
        return player.supernova.times.gte(7);
      },
    ...
    gr2: {
      unl() {
        return player.supernova.fermions.unl;
      },
      branch: ["gr1"],
    ...
    bs1: {
      ...
      req() {
        return player.supernova.times.gte(15);
      },
    ...
    bs2: {
      ...
      effDesc(x) {
        return format(x[1]) + "x to Photon, " + format(x[0]) + "x to Gluon";
      },
    },
    bs3: {
      branch: ["bs1"],
      ...
      effDesc(x) {
        return format(x) + "x" + x.softcapHTML("e1000");
      },
    },
    bs4: {
      unl() {
    ...
    fn1: {
      ...
      effect() {
        let x =
          OURO.evo >= 1
            ? expMult(player.evo.cp.level.add(1), 2).pow(
                OURO.evo >= 2 ? 0.1 : 1,
              )
            : E(1.25).pow(
    ...
    fn2: {
      ...
      req() {
        return (
          OURO.evo >= 3 ||
          (player.mass.div("1.5e56").gte("ee6") &&
            inMD() &&
            FERMIONS.onActive("01"))
        );
      },
      reqDesc() {
        return OURO.evo >= 3
          ? `YOU CAN AFFORD BECAUSE OF A EVOLUTION!`
          : `Reach ${formatMass(E("e1e6").mul(1.5e56))} while dilating mass in [Down]`;
      },
    ...
    fn3: {
      ...
      req() {
        return (
          player.supernova.fermions.points[0].gte(1e7) ||
          player.supernova.fermions.points[1].gte(1e7)
        );
      },
      reqDesc() {
        return `Reach ${format(1e7)} of any Fermions`;
      },
    ...
    fn5: {
      ...
      branch: ["fn1"],
      req() {
        return player.atom.quarks.gte("e12500") && FERMIONS.onActive("10");
      },
      reqDesc() {
        return `Reach ${format("e12500")} quarks while in [Electron]`;
      },
    ...
    fn6: {
      ...
      req() {
        return (
          OURO.evo >= 3 ||
          (player.mass.gte(uni("e4e4")) &&
            FERMIONS.onActive("02") &&
            CHALS.inChal(5))
        );
      },
      reqDesc() {
        return OURO.evo >= 3
          ? `YOU CAN AFFORD BECAUSE OF A EVOLUTION!`
          : `Reach ${formatMass(uni("e4e4"))} while in [Charm] & Challenge 5.`;
      },
      desc: `Unlock 2 more types of U-Quark & U-Fermion.`,
      cost: E(1e48),
    },
    ...
    fn10: {
      ...
      req() {
        return (
          tmp.atom.unl &&
          player.atom.points.gte("e1.5e8") &&
          FERMIONS.onActive("10") &&
          CHALS.inChal(9)
        );
      },
      reqDesc() {
        return `Reach ${format("e1.5e8")} atoms while in [Electron] and 9th Challenge.`;
      },
    ...
    qu5: {
      ...
      cost: E(100),
      effect() {
        let x = BUILDINGS.eff("tickspeed", "eff_bottom")
          .add(1)
          .log10()
          .add(1)
          .log10()
    ...
    qu_qol2: {
      ...
      req() {
        for (let x = 0; x < 6; x++)
          if (player.supernova.fermions.tiers[0][x].gte(1)) return false;
    ...
    qu_qol3: {
      ...
      reqDesc() {
        return `Reach ${formatMass(mlt(1e4))} of mass without completing Challenges 1-4 in Quantum run.`;
      },
    ...
    qu_qol5: {
      ...
      req() {
        for (let x = 5; x <= 8; x++)
          if (player.chal.comps[x].gte(1) && x != 7) return false;
        return player.mass.gte(mlt(1.35e4));
      },
      reqDesc() {
        return `Reach ${formatMass(mlt(1.35e4))} of mass without completing Challenges 5, 6 & 8 in Quantum run.`;
      },
    ...
    qu_qol6: {
      ...
      req() {
        for (let x = 0; x < 6; x++)
          if (player.supernova.fermions.tiers[1][x].gte(1)) return false;
    ...
    qu_qol7: {
      ...
      reqDesc() {
        return OURO.evo >= 1
          ? `YOU CAN AFFORD BECAUSE OF EVOLUTION!`
          : `Reach ${formatMass(mlt(5e3))} of mass without completing Challenges 9-12 in Quantum run, while in [Bottom].`;
      },
    ...
    qc2: {
      ...
      branch: ["qc1"],
      req() {
        return tmp.qu.qc_s >= 70 && player.mass.gte(uni("ee5")) && QCs.active();
      },
      reqDesc() {
    ...
    qc3: {
      ...
      branch: ["qc2"],
      req() {
        return player.qu.qc.shard >= 88;
      },
      reqDesc() {
        return `Get 88 Quantum Shards.`;
      },
    ...
    br1: {
      ...
      req() {
        return (
          tmp.qu.qc_s >= 76 && player.mass.gte(uni("e7500")) && QCs.active()
        );
      },
      reqDesc() {
        return `Reach ${formatMass(uni("e7500"))} of mass with 76 QS build (before bonus from [qc2]).`;
      },
    ...
    unl1: {
      ...
      req() {
        return OURO.evo >= 2 || player.supernova.times.gte(44);
      },
      reqDesc() {
        return OURO.evo >= 2
          ? `YOU CAN AFFORD BECAUSE OF EVOLUTION!`
    ...
    unl3: {
      ...
      branch: ["unl2"],
      req() {
        return player.qu.times.gte(200);
      },
    ...
    ct3: {
      ...
      reqDesc() {
        return `Reach ${formatMass("1e81")} of black hole during C16 & [Meta-Quark].`;
      },
    ...
    ct5: {
      ...
      effect() {
        let x = hasElement(237)
          ...
          : overflow(tmp.qu.chroma_eff[2], 10, 0.5).root(3);
        return x;
      },
      effDesc(x) {
        return formatMult(x);
    ...
    ct7: {
      ...
      reqDesc() {
        return `Get ${format(750, 0)} C14 completions.`;
      },
    },
    ct8: {
      branch: ["ct2"],
    ...
    ct9: {
      ...
      reqDesc() {
        return `Reach ${formatMass("1e400")} of black hole during C16 & [Meta-Lepton] without buying BH Condensers.`;
      },
    ...
    ct10: {
      ...
      effect() {
        let x = Decimal.pow(
          0.95,
          overflow(player.dark.c16.totalS.add(1).log10(), 2, 0.5).root(2),
        );
        if (hasElement(241)) x = x.pow(2);
        return x;
      },
      effDesc(x) {
        return formatReduction(x);
      },
    },
    ct11: {
      branch: ["ct6"],
      ...
      reqDesc() {
        return `Reach ${format(1e20)} atomic powers during C16.`;
      },
    ...
    ct12: {
      ...
      reqDesc() {
        return `Reach ${formatMass("1e1960")} of black hole during C16 & [Meta-Quark] without buying BH Condensers.`;
      },
    ...
    ct16: {
      ...
      get cost() {
        return E(OURO.evo >= 3 ? 1e15 : OURO.evo >= 2 ? 1e12 : 5e16);
      },
...
function hasTree(id) {
  return (
    ...
    !(tmp.c16.in && CORRUPTED_TREE.includes(id))
  );
}

function treeEff(id, def = 1) {
  return tmp.sn.tree_eff?.[id] || E(def);
}
...
function drawTree() {
  ...
  for (let x in tmp.sn.tree_had2[tmp.sn.tree_tab]) {
    ...
    if (branch.length > 0 && tmp.sn.tree_unlocked[id])
      for (let y in branch)
        if (tmp.sn.tree_unlocked[branch[y]]) {
...
function drawTreeBranch(num1, num2) {
  var start = document
    .getElementById("treeUpg_" + num1)
    .getBoundingClientRect();
  var end = document.getElementById("treeUpg_" + num2).getBoundingClientRect();
  var x1 =
    start.left +
    start.width / 2 -
    (document.body.scrollWidth - tree_canvas.width) / 2;
  var y1 =
    start.top + start.height / 2 - (window.innerHeight - tree_canvas.height);
  var x2 =
    end.left +
    end.width / 2 -
    (document.body.scrollWidth - tree_canvas.width) / 2;
  ...
  tree_ctx.strokeStyle =
    player.supernova.tree.includes(num2) || player.dark.c16.tree.includes(num2)
      ? color
      : tmp.sn.tree_afford[num2]
        ? "#fff"
        : "#333";
  ...
  if (player.options.tree_animation != 2) {
    tree_ctx.fillStyle =
      player.supernova.tree.includes(num2) ||
...
function updateTreeHTML() {
  ...
  if (tmp.sn.tree_choosed == "") tmp.el.tree_desc.setHTML(``);
    ...
    let req =
      CS_TREE.includes(ch) && (tmp.inf_unl || OURO.unl())
        ...
        : !t_ch.req || hasTree(ch)
          ? ""
          : `<span class="${t_ch.req() ? "green" : "red"}">${t_ch.reqDesc ? " Requirement: " + (typeof t_ch.reqDesc == "function" ? t_ch.reqDesc() : t_ch.reqDesc) : ""}</span>`;
    let desc = t_ch.desc;
    if (t_ch.evo_desc && OURO.evo >= t_ch.evo_desc[0])
      desc = desc.strike() + " " + t_ch.evo_desc[1];
  ...
  for (let i = 0; i < TREE_TAB.length; i++) {
    ...
    tmp.el["tree_tab" + i + "_notify"].setDisplay(
      tmp.sn.tree_afford2[i].length > 0,
    );
    tmp.el["tree_tab" + i + "_div"].setDisplay(tmp.sn.tree_tab == i);
    if (tmp.sn.tree_tab == i)
      for (let x = 0; x < tmp.sn.tree_had2[i].length; x++) {
        ...
        if (unl)
          tmp.el["treeUpg_" + id].setClasses(
            player.dark.c16.tree.includes(id) ||
              (c16 && CORRUPTED_TREE.includes(id))
              ? {
                  btn_tree: true,
                  corrupted: true,
                  choosed: id == tmp.sn.tree_choosed,
                }
              : {
                  btn_tree: true,

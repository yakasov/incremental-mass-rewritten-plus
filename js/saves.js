...
function calc(dt) {
  ...
  if (evo < 2) {
    ...
    if (tmp.bh.unl && !player.qu.en.hr[0])
  ...
  createPrompt(
    ...
    (loadgame) => {
      ...
      if (st == "OJY$VFe*b") {
        ...
        addNotify(
          'Please lift mass, please!!!<br><img style="width: 100%; height: 100%" src="https://www.davelabowitz.com/wp-content/uploads/Sisyphus-e1557869810488.jpg">'
        );
        var s = document.getElementById("sisyphus"),
          f = () => {

...
!(function () {
    ...
    function p(t, e) {
        ...
        const o = (function (t, e) {
            ...
            return (
                (e || Object.keys(n).concat(Object.keys(o))).forEach(
                    function t(e) {
                        if (n[e]) return (i[e] = []);
                        if (!(e in i)) {
                            i[e] = null;
    ...
    function wt(t, e) {
        ...
        [o, i].forEach((t) => {
            ...
            r % 2 == 1 &&
                (s.left !== s.top &&
                    ((i = s.left), (s.left = s.top), (s.top = i)),
                s.width !== s.height &&
                    ((i = s.width), (s.width = s.height), (s.height = i))),
                e.length &&
                    (c = '<g transform="' + e.join(" ") + '">' + c + "</g>");
        });
        const a = i.width,
            u = i.height,
            l = s.width,
                ...
                attributeChangedCallback(t) {
                    if ("inline" === t) {
                        const t = mt(this),
                            e = this._state;
                        t !== e.inline &&
                            ((e.inline = t), Et(this._shadowRoot, t));

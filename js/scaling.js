  ...
  if (type == 0) {
    if (name == "rank") {
      ...
      if (player.mainUpg.bh.includes(3))
        start = start.add(
          tmp.upgs ? (tmp.upgs.main ? tmp.upgs.main[2][3].effect : 0) : 0
        );
    ...
    if (name == "tickspeed") {
      ...
      if (player.mainUpg.atom.includes(10))
        start = start.add(
          tmp.upgs ? (tmp.upgs.main ? tmp.upgs.main[3][10].effect : 0) : 0
        );
    } else if (name == "prestige0") {
      if (hasElement(175)) start = start.add(30);
      if (hasElement(194)) start = start.mul(2);
  ...
  if (type == 0) {
    if (name == "rank") {
      ...
      if (player.mainUpg.rp.includes(8))
        power = power.mul(tmp.upgs.main ? tmp.upgs.main[1][8].effect : 1);
    } else if (name == "tickspeed") {

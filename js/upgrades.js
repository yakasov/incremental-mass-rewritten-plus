const UPGS = {
    mass: {
        ...
        buy(x, manual = false) {
            ...
            if (player.mass.gte(cost)) {
                if (!player.mainUpg.bh.includes(1))
        ...
        1: {
            unl() {
                return (
                    player.ranks.rank.gte(1) || player.mainUpg.atom.includes(1)
                );
            },
            title: "Muscler",
            start: E(10),
        ...
        2: {
            unl() {
                return (
                    player.ranks.rank.gte(2) || player.mainUpg.atom.includes(1)
                );
            },
            title: "Booster",
            start: E(100),
        ...
        3: {
            unl() {
                return (
                    player.ranks.rank.gte(3) || player.mainUpg.atom.includes(1)
                );
            },
            title: "Stronger",
            start: E(1000),
    ...
    main: {
        ...
        1: {
            ...
            can(x) {
                return (
                    player.rp.points.gte(this[x].cost) &&
                    !player.mainUpg.rp.includes(x)
                );
            },
            buy(x) {
                if (this.can(x)) {
        ...
        2: {
            ...
            can(x) {
                return (
                    player.bh.dm.gte(this[x].cost) &&
                    !player.mainUpg.bh.includes(x)
                );
            },
            buy(x) {
                if (this.can(x)) {
        ...
        3: {
            ...
            13: {
                unl() {
                    return (
                        (player.md.break.active && player.qu.rip.active) ||
                        hasElement(128)
                    );
                },
        ...
        4: {
            ...
            can(x) {
                return (
                    player.qu.rip.amt.gte(this[x].cost) &&
                    !player.mainUpg.br.includes(x)
                );
            },
            buy(x) {
                if (this.can(x)) {
...
function resetMainUpgs(id, keep = []) {
    ...
    for (let x = 0; x < player.mainUpg[id2].length; x++)
        if (keep.includes(player.mainUpg[id2][x]))
            k.push(player.mainUpg[id2][x]);
